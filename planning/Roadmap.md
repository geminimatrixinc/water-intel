...
- **VentureLab Accelerate AI (https://www.venturelab.ca/aai)** — deferred, revisit after Colin/Mitacs + Two Rivers threads resolve (2026-07-22). Non-dilutive 6-month applied-AI accelerator (mentors, advisors, compute, investment-readiness, demo day); no cash grant, no Indigenous-specific angle, stage/sector fit is strong (MVP + traction, applied AI). Decision was about time-cost of a 6-month commitment while solo and juggling 3 verticals, not about fit — application itself is cheap once other threads settle. Revisit once Colin/expert outcome, Mitacs, and Two Rivers AEP are further along.
- **NRC AI for Productivity Challenge** (https://nrc.canada.ca/en/research-development/research-collaboration/programs/ai-productivity-challenge-program) — parked, not a fit *yet* (2026-07-22). Targets cleantech/agriculture/manufacturing at **high TRL — "AI-based prototypes being tested in an operational environment"**; Water-Intel is Phase 1 historical-data proxy, not an operational deployment, so this is stage-mismatched now. Structure is collaborative R&D alongside NRC researchers (like Mitacs, but with NRC), not a standalone grant. Correct trigger to revisit: once Phase 2 has a real operational community deployment. Optional low-cost move: one inquiry email to NRC.AIProductivity-IAProductivite.CNRC@nrc-cnrc.gc.ca to flag interest for a future intake — not worth a real application at Phase 1.
